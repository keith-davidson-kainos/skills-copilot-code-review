...
def init_database():
    ...
    if announcements_collection.count_documents({}) == 0:
        for announcement in initial_announcements:
            document = {**announcement, "_id": announcement["id"]}
...
initial_announcements = [
    {
        "id": "summer-activities-registration",
        "title": "Summer Activity Registration",
        "message": "Activity registration is open through July 15. Review your choices early to secure a place in limited-capacity clubs.",
        "start_date": None,
